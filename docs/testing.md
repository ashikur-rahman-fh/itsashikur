...
`@ashikur-portfolio/shared` API tests live under `packages/shared/src/api/core/`:
...
Frontend home page tests assert integration with `@ashikur-portfolio/shared/ui` imports. See [`ui-system.md`](ui-system.md).
