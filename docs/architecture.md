...
- **Shared UI** (`packages/shared/src/ui/`) — **Ashikur Portfolio** theme (muted slate primary, soft neutrals, Inter + Consolas mono, light/dark). Tailwind v4, shadcn primitives, Basecoat CSS. Import via `@ashikur-portfolio/shared/ui`. See [`ui-system.md`](ui-system.md).
- Hooks (`useApi`)
